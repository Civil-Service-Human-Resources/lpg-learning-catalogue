...
var CLOSE_METHODS = {
    ...
    csl: function () {
        console.log('corePrimaryLoadList.min.js: csl close start');
        alert('corePrimaryLoadList.min.js start');
        ...
        console.log('corePrimaryLoadList.min.js: csl close end');
        alert('corePrimaryLoadList.min.js end');
