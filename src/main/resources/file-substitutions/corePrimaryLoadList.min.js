...
var CLOSE_METHODS = {
    ...
    csl: function () {
        ...
        alert('corePrimaryLoadList.min.js: csl close');
...
// Native js method to run on document ready that is cross browser and also will not override any existing on ready code
function r(f) {
